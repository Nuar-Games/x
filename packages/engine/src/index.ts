 ...
 *
 * Public API: set up a match, advance it, apply commands, enumerate legal
 * commands, and read derived values. Nothing here lets a caller move cards or
 * change state directly; all changes go through applyCommand. Tests import
 * internals from src/.
 */
